...
-- AddForeignKey
ALTER TABLE "collaborations" ADD CONSTRAINT "collaborations_initiator_id_fkey" FOREIGN KEY ("initiator_id") REFERENCES "avatars"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "collaborations" ADD CONSTRAINT "collaborations_partner_id_fkey" FOREIGN KEY ("partner_id") REFERENCES "avatars"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
