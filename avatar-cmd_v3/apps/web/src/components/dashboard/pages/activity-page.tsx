...
const typeMapping: Record<string, ActivityType> = {
  ...
  alert: "alert",
  learn: "learn",
  content_generated: "post",
  post_failed: "alert",
  post_dispatched: "post",
  automation_triggered: "post",
  knowledge_fetch_started: "knowledge",
  security_blocked: "alert",
  soul_updated: "learn",
  avatar_created: "learn",
  avatar_paused: "learn",
  avatar_resumed: "learn",
  trend_detected: "learn",
  collab_updated: "collab",
}
